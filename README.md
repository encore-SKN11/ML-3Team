...
| 준희  |  |
| 유경  | 데이터에 알맞은 머신러닝 모델을 찾기 위한 고민부터 여러 가지 머신러닝 모델을 사용해가면서 학습시키면서 정확도를 높이거나 과적합을 해결하는 과정을 거치면서 모호했던 개념들이 확실하게 잡힐 수 있었습니다! 그리고 팀원분들께 의문점에 대해 여쭤보면 확실하고 명확하게 답변해 주셔서 얻어가는게 많은 프로젝트로 마무리할 수 있었습니다🤩  |
