...
| 준희  | 직접 해본 EDA를 가지고 적절한 머신러닝 모델을 찾아서 적용하고 이를 통해 발생하는 문제들을 해결하고, 시각화 자료로 도출하면서 지금까지 배운 지식들을 많이 이해할 수 있게 되었습니다. 또한 팀원분들께서 각자 맡은 역할을 성실히 이행하시고, 진행하다가 막히는 부분이 있으면 같이 찾아보면서 해결하고 수월하게 진행할 수 있어 감사했던 프로젝트였습니🥔 |
